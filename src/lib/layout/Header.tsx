...
export function Header() {
  ...
  const currentBudgetPath = useMemo(() => {
    ...
    console.log("Header: Huidige datum:", now);
    console.log("Header: Year:", year, "Month:", month);
    console.log("Header: Budget path:", `/budget/${year}/${month}`);
          ...
          <HStack spacing={6} align="center">
            ...
            <Link
              ...
              style={{
                ...
                fontWeight: isBudgets ? "bold" : "normal",
                cursor: isBudgets ? "default" : "pointer",
              }}
            >
              Budgets
            </Link>
